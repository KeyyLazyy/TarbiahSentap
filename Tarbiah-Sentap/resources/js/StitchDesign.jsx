...
export default function StitchDesign({ setView, books = [], addToCart }) {
    const mockBooks = [
    ...
    return (
        <div className="bg-surface text-on-surface font-body-md overflow-x-hidden paper-texture">
            {/* TopNavBar removed in favor of UnifiedHeader */}
                ...
                <div className="relative h-full w-full" id="hero-carousel">
                    <div className="absolute inset-0 transition-opacity duration-1000 opacity-100">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-6">
                            <span className="text-secondary-fixed font-label-md tracking-[0.2em] uppercase mb-4">Warisan Terpelihara</span>
                            <h1 className="text-surface font-display-lg text-display-lg max-w-4xl mb-8">Edisi Terhad untuk Pengumpul Tegar</h1>
            ...
            <section className="max-w-container-max mx-auto px-margin-desktop py-section-gap">
                <div className="flex justify-between items-end mb-12">
                    <div>
                        <h2 className="font-headline-lg text-headline-lg mb-2">Siri Pilihan</h2>
                        <p className="font-body-lg text-body-lg text-on-surface-variant italic">Teras utama dunia penulisan.</p>
                    </div>
                    <div className="hidden md:block h-[1px] bg-outline-variant flex-grow mx-12 opacity-30"></div>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-gutter" id="product-grid">
                        ...
                        <div key={book.id} className="group cursor-pointer book-card-hover">
                            <div className="aspect-[2/3] overflow-hidden relative border border-outline-variant/20 transition-all duration-500 group-hover:border-secondary bg-surface">
                                ...
                                <div className="quick-view absolute bottom-0 left-0 right-0 bg-surface/90 py-3 text-center opacity-0 translate-y-4 transition-all duration-300">
                                    <span className="font-label-md text-label-md uppercase tracking-widest text-on-surface">Lihat</span>
                                </div>
                            </div>
                            <div className="mt-4 flex flex-col h-full">
                                ...
                                <p className="mt-2 font-label-md text-label-md text-primary mb-3">RM {Number(book.price).toFixed(2)}</p>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="max-w-container-max mx-auto px-margin-desktop">
                    <div className="editorial-split items-center gap-16">
                        ...
                        <div className="order-1 md:order-2">
                            <span className="text-secondary font-label-md uppercase tracking-widest mb-6 block">Pilihan Editor</span>
                            <h2 className="font-display-lg text-display-lg-mobile md:text-display-lg mb-8 leading-tight">Koleksi Warisan: Vol. I</h2>
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex items-center gap-4 py-4 border-b border-outline/20">
                                    ...
                                    <span className="font-label-md text-label-md">Dokumentasi Keaslian yang Disahkan</span>
                                </div>
                                <div className="flex items-center gap-4 py-4 border-b border-outline/20">
                                    <span className="material-symbols-outlined text-secondary">auto_stories</span>
                                    <span className="font-label-md text-label-md">Terhad kepada 50 Edisi Bernombor</span>
                                </div>
                            </div>
            ...
            <section className="py-section-gap bg-surface-container relative overflow-hidden">
                ...
                <div className="max-w-container-max mx-auto px-margin-desktop relative z-10">
                    <div className="text-center mb-16">
                        <h2 className="font-headline-lg text-headline-lg">Penulis Tersohor</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div className="group">
                            ...
                            <p className="font-body-md text-body-md text-on-surface-variant line-clamp-3">Pengasas Tarbiah Sentap yang menjiwai dakwah santai menyentuh hati setiap pembaca.</p>
                        </div>
                        {/* Writer 2 */}
                        <div className="group">
                            <div className="relative mb-6 overflow-hidden">
                            ...
                            <p className="font-body-md text-body-md text-on-surface-variant line-clamp-3">Sinar panduan di dunia moden, penulisannya telah mentakrifkan semula kepercayaan kontemporari melalui kejujuran emosi.</p>
                        </div>
                        {/* Writer 3 */}
                        <div className="group">
                            <div className="relative mb-6 overflow-hidden">
                            ...
                            <p className="font-body-md text-body-md text-on-surface-variant line-clamp-3">Pakar naratif tulus ikhlas, menggabungkan perkara biasa dengan mendalam dalam tarian sastera yang diselit puisi.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-section-gap">
                <div className="max-w-[800px] mx-auto px-margin-mobile text-center border border-secondary/20 p-12 md:p-20 relative">
                    ...
                    <h2 className="font-headline-lg text-headline-lg mb-6">Sertai Kelab Sastera</h2>
                    ...
                    <form className="flex flex-col md:flex-row gap-4" onSubmit={(e) => e.preventDefault()}>
                        <input 
                            ...
                            type="email" 
                        />
                        <button className="bg-on-surface text-surface px-12 py-4 font-label-md text-label-md uppercase tracking-widest hover:bg-primary transition-colors border-0 cursor-pointer" type="submit">Sertai Sekarang</button>
                    </form>
                    <p className="mt-6 font-label-sm text-label-sm text-on-tertiary-container">Menghormati privasi anda adalah prinsip utama kami.</p>
                </div>
            </section>
